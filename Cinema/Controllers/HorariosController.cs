...
namespace Cinema.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public HorariosController(CinemaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("HorarioId,HorarioSessao")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HorarioId,HorarioSessao")] Horario horario)
        {
